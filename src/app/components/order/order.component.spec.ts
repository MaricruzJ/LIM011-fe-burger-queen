...
describe('OrderComponent', () => {
  ...
  beforeEach(async(() => {
    const orderServiceStub = jasmine.createSpyObj('OrderService', ['addQuantity', 'subtractQuantity', 'deleteItem']);
  ...
  it('3.- Deberia llamar a sendOrder al dar click al button', () => {
  ...
  it('4.- Deberia llamar a sendOrder al dar submit al form', () => {
    // creamos un spy de sendOrder method para comprobar que haya sido llamado
    spyOn(component, 'sendOrder');
  ...
  it('5.- Deberia llamar a setOrder al ejecutar sendOrder', () => {
